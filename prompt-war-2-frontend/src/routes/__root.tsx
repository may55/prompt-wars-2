...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "GenAI-powered cultural travel across India. Discover hidden gems, festivals, and heritage." },
      { name: "author", content: "Wayfinder" },
      { property: "og:title", content: "Wayfinder — Discover Destinations & Local Culture" },
      { property: "og:description", content: "Discover destinations and engage with local culture in meaningful ways." },
